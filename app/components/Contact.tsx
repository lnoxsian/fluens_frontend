          ...
          <div>
            <div className="bg-gray-50 p-8 rounded-xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-teal-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-teal-700 transition-all duration-300 transform hover:scale-105"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">fluens.project@example.com</p>
                </div>
              </div>

              <div className="flex items-start">
                <div className="w-12 h-12 bg-gray-900 rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-teal-50 p-6 rounded-xl">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Accessible Technology Development</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-teal-600 rounded-full mr-2"></div>
                  <span className="text-gray-700">Wearable Device Innovation</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-purple-600 rounded-full mr-2"></div>
                  <span className="text-gray-700">Machine Learning for Sign Language</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-orange-600 rounded-full mr-2"></div>
                  <span className="text-gray-700">Inclusive Communication Solutions</span>
                </div>
              </div>
            </div>
