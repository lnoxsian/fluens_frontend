      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            {/* Problem Statements */}
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Problem Statements</h3>
              
              <div className="space-y-6">
                <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-500">
                  <h4 className="text-lg font-semibold text-red-900 mb-3">Social Problem</h4>
                ...
                <div className="bg-orange-50 p-6 rounded-lg border-l-4 border-orange-500">
                  <h4 className="text-lg font-semibold text-orange-900 mb-3">Technical Problem</h4>
            ...
            {/* System Design */}
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">System Design Approach</h3>
              
              <div className="space-y-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-900 mb-2">Data Collection & Processing</h4>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-green-900 mb-2">Machine Learning Pipeline</h4>
          ...
          <div className="lg:sticky lg:top-24">
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-6 text-center">System Architecture</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white p-4 rounded-lg text-center shadow-sm">
                  ...
                  <div className="font-semibold text-gray-800">Hall Effect Sensors</div>
                  <div className="text-sm text-gray-600">Gesture Detection</div>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg text-center shadow-sm">
                  <div className="text-2xl mb-2">📡</div>
                  <div className="font-semibold text-gray-800">ESP32 Microcontroller</div>
                  <div className="text-sm text-gray-600">Data Transmission</div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-blue-100 p-4 rounded-lg text-center">
                    ...
                    <div className="font-semibold text-blue-800 text-sm">Cloud ML</div>
                  </div>
                  <div className="bg-teal-100 p-4 rounded-lg text-center">
                    <div className="text-xl mb-2">🥧</div>
                    <div className="font-semibold text-teal-800 text-sm">Raspberry Pi</div>
                  </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg text-center shadow-sm">
                  <div className="text-2xl mb-2">🔊</div>
                  <div className="font-semibold text-gray-800">Speech Output</div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <h4 className="font-semibold text-gray-800 mb-4">Key Specifications</h4>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">10 meters</span>
                  </div>
                </div>
              </div>
            </div>
